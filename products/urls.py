...
urlpatterns = [
    ...
    path('product_detail/<int:pk>/',views.detail_product,name='detail_product')#route to product detail view, when the user accesses the /products/<id> URL of the application then this view function will be called and it will render the detail_product.html template which is located in templates folder as we have specified the template directory in settings.py as BASE_DIR / 'templates'
